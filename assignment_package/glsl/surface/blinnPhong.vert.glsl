...
uniform vec3 u_Cam;         // vector that defines camera position
...
void main()
{
    ...
    fs_LightVec = vec4(u_Cam, 0) - modelposition; // Compute the direction in which the light source lies without using inverse
