...
/// Start Perline Noise Function found from https://github.com/ashima/webgl-noise/blob/master/src/classicnoise3D.glsl
...
void main()
{
    ...
    float noise = cnoise(vec3(modelposition));

    fs_Noise = noise;

    modelposition += fs_Nor * noise * 0.25 * sin(u_Time/10.0);
