...
public:
    ...
    int unifCam; // A handle for the "uniform" vec3 representing cameras position in world space
...
public:
    ...
    // Pass the camera view into the shader on the GPU
    void setCamVector(const glm::vec3 &camW);
};
